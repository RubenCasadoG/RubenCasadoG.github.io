...
En la máquina **Colddbox** de **TryHackMe**, explotaremos un gestor de contenidos **Wordpress**, por el cual accederemos a la máquina, y veremos 7 posibles escaladas de privilegios.
