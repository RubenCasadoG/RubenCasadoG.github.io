...
En la máquina **Blog** de dificultad media de **TryHackMe**, exploto un **Wordpress**, por el cual accedo a la máquina gracias a la vulnerabilidad **CVE-2019-8942**, y escalo privilegios gracias al bit **SUID** de un binario.
...
- Y utilizo la siguiente técnica con **mkfifo** para pobtener la **Reverse Shell**.
